...
```javascript
readWASM = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-wasm@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/fs-read-wasm@umd/bundle.js"></script>
```
